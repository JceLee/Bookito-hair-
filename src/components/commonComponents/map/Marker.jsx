    ...
    return designer ? (
        <div className="marker">
            ...
            <Popover
                ...
                overlayClassName="designerPopover desktopOnly"
                content={
                    <div className="popoverContent desktopOnly">
            ...
            >
                <Button className="markerButton desktopOnly" type="primary" shape="circle" icon={<ScissorOutlined />} />
            </Popover>

            <div>
                <Button className="markerButton mobileOnly" type="primary" shape="circle" onClick={display} icon={<ScissorOutlined />}/>
                <Modal
                    className="designerPopover mobileOnly"
                    visible={visible}
                    footer={null}
                    onCancel={hide}
                    // maskClosable={false}
                    ...
                    style={{ top: "70vh" }}
                >
                        <div className="popoverContent mobileOnly">
                            <Link to={`/designer_profile?uid=${designer.uid}`}>
